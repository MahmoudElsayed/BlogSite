...
namespace Blog.DAL
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        private readonly IUnitOfWork<BlogContext> _uow;
        ...
        public Repository(IUnitOfWork<BlogContext> unitOfWork, IHttpContextAccessor httpContext, IConfiguration configuration)
        {
            _uow = unitOfWork;
            _db = _uow.BlogContext;
